...
const SignUpPage = () => {
  ...
  const [isHidden, setIsHidden] = useState<any>({
    password: { isOpen: true },
    confirm_password: { isOpen: true },
  });
  ...
  return (
    <div className="bg-[#fdf8f8] w-full min-h-screen flex gap-8 ">
      ...
      <div className="bg-[#61aeb6] 3xl:w-[40%] 2xl:w-[38%] lg:w-[35%] w-full px-8 lg:block flex items-center justify-center">
        <div className="flex flex-col justify-center items-center gap-4 lg:h-full lg:bg-[#61aeb6] bg-[#3e6b70] md:h-[60%] h-[65%] lg:w-full md:w-[45%] rounded-lg lg:px-0 md:px-8 px-4 md:py-0 py-4">
          <h1 className="3xl:text-5xl 2xl:text-4xl lg:text-3xl text-2xl font-semibold text-[#020303] w-full text-start md:py-6 py-1 plus-jakarta-sans-header ">
            SignUp to NoteZipper
          </h1>
          <div className="w-full">
            ...
            <input
              ...
              className="w-full 3xl:h-16 2xl:h-14 h-10 md:text-lg text-base text-black rounded-md px-4"
            />
          </div>
          <div className="w-full">
            {/* <label htmlFor="email">Name:</label> */}
          ...
          <div className="w-full relative">
            ...
            <input
              name="password"
              type={isHidden?.password?.isOpen ? "password" : "text"}
          ...
          <div className="w-full relative">
            ...
            <input
              ...
              type={isHidden?.confirm_password?.isOpen ? "password" : "text"}
            ...
            >
              <img
                src={
                  isHidden?.confirm_password?.isOpen
                    ? "/icons/hidden.svg"
                    : "/icons/shown.svg"
                }
              />
